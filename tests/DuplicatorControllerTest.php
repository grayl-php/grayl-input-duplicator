<?php
    ...
    */
   class DuplicatorControllerTest extends TestCase
   {
      ...
      public function testCreateDuplicatorController (): DuplicatorController
      {
         ...
         $duplicator = DuplicatorPorter::getInstance()
                                       ->newDuplicatorController( $tag,
                                                                  null );

         // Check the type of object created
         $this->assertInstanceOf( DuplicatorController::class,
                                  $duplicator );
       ...
       * @throws \Exception
       */
      public function testDuplicatorControllerSuccess ( DuplicatorController $duplicator ): DuplicatorController
      {
       ...
       * @throws \Exception
       */
      public function testDuplicatorControllerFailure ( DuplicatorController $duplicator ): void
      {
